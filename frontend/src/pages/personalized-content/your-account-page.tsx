...
export const YourAccountPage = () => {
  const links = [
    ...
    },
    {
      id: 3,
      title: "Your Address",
      description: "Edit addresses for orders and gift",
      href: "/your-address",
      icon: Locate,
    },
    {
    ...
    },
    {
      ...
      description: "Edit email alerts, messages and ads",
    ...
    },
    {
      ...
      description: "Request your data, manage apps and services",
      href: "/request-your-data",
      icon: Database,
    },
  ];
