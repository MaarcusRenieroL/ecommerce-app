...
export const SignUpForm: FC<Props> = ({ pathName }) => {
	...
	const form = useForm<z.infer<typeof signUpSchema>>({
		resolver: zodResolver(signUpSchema), defaultValues: {
			firstName: "", lastName: "", email: "", password: "", confirmPassword: "", addressLine1: "", addressLine2: "", addressLine3: "", phoneNumber: ""
		}
	})
			...
			<Form {...form}>
				<form onSubmit={form.handleSubmit(onSubmit)}>
					<div className="space-y-4">
						...
						)} name="addressLine1" control={form.control}/>
						...
						)} name="addressLine2" control={form.control}/>
						...
						)} name="addressLine3" control={form.control}/>
						...
						)} name="phoneNumber" control={form.control}/>
