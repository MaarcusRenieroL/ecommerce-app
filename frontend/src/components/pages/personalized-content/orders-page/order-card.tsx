				...
				<div className="flex justify-between w-full mt-5">
					<div className="space-y-3">
						<div className="flex items-center w-full gap-5">
							<img src="/assets/placeholder.svg" alt="image" className="w-24 h-24 rounded-xl"/>
							<span>Product 1</span>
						</div>
						<div className="flex items-center w-full gap-5">
							<img src="/assets/placeholder.svg" alt="image" className="w-24 h-24 rounded-xl"/>
					...
					<div className="flex flex-col items-start space-y-5">
						...
						<Button variant="outline" className="w-full">Cancel this delivery</Button>
						<Button variant="outline" className="w-full">Leave seller feedback</Button>
					</div>
				</div>
			</CardContent>
