...
import { Pagination, PaginationItem, PaginationContent, PaginationPrevious, PaginationNext } from "@/components/ui/pagination"
			...
			<Pagination className="mt-10">
				<PaginationContent>
					...
					<PaginationItem>
						<PaginationNext
							className={
								endIndex > products.length ? "pointer-events-none opacity-50" : undefined
							}
							onClick={() => {
								setStartIndex(startIndex + rowsPerPage);
								setEndIndex(endIndex + rowsPerPage);
