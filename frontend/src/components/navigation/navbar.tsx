...
import { Sheet, SheetContent, SheetHeader, SheetTitle, SheetTrigger, SheetFooter } from "@/components/ui/sheet.tsx";
			...
			<header
				...
				<div className="flex items-center space-x-5">
					...
					<Sheet>
						...
						<SheetContent side="right" className="h-full flex flex-col items-start justify-between w-full">
							<SheetHeader>
										...
										<ScrollArea className="h-[65vh] w-full">
											{cartItems.map((item) => (
												<Card key={item.id} className="mb-4 w-full">
													<img src={item.image} alt={item.name} className="w-full h-32 object-cover rounded mr-4"/>
